--- The p6m platform standards, held against the rust BASIC service archetype.
---
...
--- network. Docker is the single requirement — no Rust toolchain on the host, so this suite behaves
...
prova.group("rust-basic: the archetype itself", function(g)
